...
exports.renderHallTicket = async (req, res) => {
    ...
    try {
        ...
        const settings = await ExamSettings
            .findOne()
            .lean();
        ...
        if (hallTicket && hallTicket.hallTicketNumber) {
